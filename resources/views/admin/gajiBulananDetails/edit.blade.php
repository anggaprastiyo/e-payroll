        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.gajiBulananDetail.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.gaji-bulanan-details.update", [$gajiBulananDetail->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group {{ $errors->has('gaji_bulanan') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="gaji_bulanan_id" id="gaji_bulanan_id" required>
                                @foreach($gaji_bulanans as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('gaji_bulanan_id') ? old('gaji_bulanan_id') : $gajiBulananDetail->gaji_bulanan->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('user') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="user_id" id="user_id" required>
                                @foreach($users as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('user_id') ? old('user_id') : $gajiBulananDetail->user->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('user'))
                        ...
                        <div class="form-group {{ $errors->has('gaji_pokok') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="gaji_pokok" id="gaji_pokok" value="{{ old('gaji_pokok', $gajiBulananDetail->gaji_pokok) }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('total_tunjangan') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="total_tunjangan" id="total_tunjangan" value="{{ old('total_tunjangan', $gajiBulananDetail->total_tunjangan) }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('total_iuran_bpjstk') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="total_iuran_bpjstk" id="total_iuran_bpjstk" value="{{ old('total_iuran_bpjstk', $gajiBulananDetail->total_iuran_bpjstk) }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('total_iuran_bpjskes') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="total_iuran_bpjskes" id="total_iuran_bpjskes" value="{{ old('total_iuran_bpjskes', $gajiBulananDetail->total_iuran_bpjskes) }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('total_lembur') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="total_lembur" id="total_lembur" value="{{ old('total_lembur', $gajiBulananDetail->total_lembur) }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('total_pajak') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="total_pajak" id="total_pajak" value="{{ old('total_pajak', $gajiBulananDetail->total_pajak) }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('total_premi_bpjstk') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="total_premi_bpjstk" id="total_premi_bpjstk" value="{{ old('total_premi_bpjstk', $gajiBulananDetail->total_premi_bpjstk) }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('total_premi_bpjskes') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="total_premi_bpjskes" id="total_premi_bpjskes" value="{{ old('total_premi_bpjskes', $gajiBulananDetail->total_premi_bpjskes) }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('premi_taspen_save') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="premi_taspen_save" id="premi_taspen_save" value="{{ old('premi_taspen_save', $gajiBulananDetail->premi_taspen_save) }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('total_potongan_absensi') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="total_potongan_absensi" id="total_potongan_absensi" value="{{ old('total_potongan_absensi', $gajiBulananDetail->total_potongan_absensi) }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('total_potongan_pihak_ketiga') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="total_potongan_pihak_ketiga" id="total_potongan_pihak_ketiga" value="{{ old('total_potongan_pihak_ketiga', $gajiBulananDetail->total_potongan_pihak_ketiga) }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('total_thp') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="total_thp" id="total_thp" value="{{ old('total_thp', $gajiBulananDetail->total_thp) }}" step="0.01" required>
