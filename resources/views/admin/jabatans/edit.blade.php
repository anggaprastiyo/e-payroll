                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.jabatans.update", [$jabatan->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('kode') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="kode" id="kode" value="{{ old('kode', $jabatan->kode) }}">
                            @if($errors->has('kode'))
                        ...
                        <div class="form-group {{ $errors->has('nama') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="nama" id="nama" value="{{ old('nama', $jabatan->nama) }}" required>
                            @if($errors->has('nama'))
                        ...
                        <div class="form-group {{ $errors->has('koefisien_tunjangan') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="koefisien_tunjangan" id="koefisien_tunjangan" value="{{ old('koefisien_tunjangan', $jabatan->koefisien_tunjangan) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('is_lembur_otomatis') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Models\Jabatan::IS_LEMBUR_OTOMATIS_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="is_lembur_otomatis_{{ $key }}" name="is_lembur_otomatis" value="{{ $key }}" {{ old('is_lembur_otomatis', $jabatan->is_lembur_otomatis) === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group {{ $errors->has('tujangan_kinerja') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="tujangan_kinerja" id="tujangan_kinerja" value="{{ old('tujangan_kinerja', $jabatan->tujangan_kinerja) }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('tunjangan_komunikasi') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="tunjangan_komunikasi" id="tunjangan_komunikasi" value="{{ old('tunjangan_komunikasi', $jabatan->tunjangan_komunikasi) }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('tunjangan_cuti') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="tunjangan_cuti" id="tunjangan_cuti" value="{{ old('tunjangan_cuti', $jabatan->tunjangan_cuti) }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('tunjangan_pakaian') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="tunjangan_pakaian" id="tunjangan_pakaian" value="{{ old('tunjangan_pakaian', $jabatan->tunjangan_pakaian) }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('tunjangan_jabatan') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="tunjangan_jabatan" id="tunjangan_jabatan" value="{{ old('tunjangan_jabatan', $jabatan->tunjangan_jabatan) }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('tunjangan_kemahalan') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="tunjangan_kemahalan" id="tunjangan_kemahalan" value="{{ old('tunjangan_kemahalan', $jabatan->tunjangan_kemahalan) }}" step="0.01" required>
