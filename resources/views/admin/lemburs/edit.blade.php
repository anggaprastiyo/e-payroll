    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.lemburs.update", [$lembur->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('jam_mulai') ? 'is-invalid' : '' }}" type="text" name="jam_mulai" id="jam_mulai" value="{{ old('jam_mulai', $lembur->jam_mulai) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('jam_akhir') ? 'is-invalid' : '' }}" type="text" name="jam_akhir" id="jam_akhir" value="{{ old('jam_akhir', $lembur->jam_akhir) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('keterangan_pekerjaan') ? 'is-invalid' : '' }}" name="keterangan_pekerjaan" id="keterangan_pekerjaan">{!! old('keterangan_pekerjaan', $lembur->keterangan_pekerjaan) !!}</textarea>
