                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.lemburs.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('jam_mulai') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control timepicker" type="text" name="jam_mulai" id="jam_mulai" value="{{ old('jam_mulai') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('jam_akhir') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control timepicker" type="text" name="jam_akhir" id="jam_akhir" value="{{ old('jam_akhir') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('keterangan_pekerjaan') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control ckeditor" name="keterangan_pekerjaan" id="keterangan_pekerjaan">{!! old('keterangan_pekerjaan') !!}</textarea>
