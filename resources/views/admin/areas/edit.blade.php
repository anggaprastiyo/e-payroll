    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.areas.update", [$area->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama') ? 'is-invalid' : '' }}" type="text" name="nama" id="nama" value="{{ old('nama', $area->nama) }}" required>
                @if($errors->has('nama'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('umr') ? 'is-invalid' : '' }}" type="number" name="umr" id="umr" value="{{ old('umr', $area->umr) }}" step="0.01" required>
                @if($errors->has('umr'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tunjangan_kemahalan') ? 'is-invalid' : '' }}" type="number" name="tunjangan_kemahalan" id="tunjangan_kemahalan" value="{{ old('tunjangan_kemahalan', $area->tunjangan_kemahalan) }}" step="0.01">
