    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.potongan-absensis.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('terlambat') ? 'is-invalid' : '' }}" type="number" name="terlambat" id="terlambat" value="{{ old('terlambat', '') }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pulang_cepat') ? 'is-invalid' : '' }}" type="number" name="pulang_cepat" id="pulang_cepat" value="{{ old('pulang_cepat', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('izin') ? 'is-invalid' : '' }}" type="number" name="izin" id="izin" value="{{ old('izin', '') }}" step="0.01">
                @if($errors->has('izin'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sakit') ? 'is-invalid' : '' }}" type="number" name="sakit" id="sakit" value="{{ old('sakit', '') }}" step="0.01">
                @if($errors->has('sakit'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tanpa_kabar') ? 'is-invalid' : '' }}" type="number" name="tanpa_kabar" id="tanpa_kabar" value="{{ old('tanpa_kabar', '') }}" step="0.01">
