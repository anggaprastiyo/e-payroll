                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.keluargas.update", [$keluarga->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('nama') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="nama" id="nama" value="{{ old('nama', $keluarga->nama) }}" required>
                            @if($errors->has('nama'))
                        ...
                        <div class="form-group {{ $errors->has('jenis_kelamin') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Models\Keluarga::JENIS_KELAMIN_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="jenis_kelamin_{{ $key }}" name="jenis_kelamin" value="{{ $key }}" {{ old('jenis_kelamin', $keluarga->jenis_kelamin) === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group {{ $errors->has('tempat_lahir') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="tempat_lahir" id="tempat_lahir" value="{{ old('tempat_lahir', $keluarga->tempat_lahir) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('tanggal_lahir') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="tanggal_lahir" id="tanggal_lahir" value="{{ old('tanggal_lahir', $keluarga->tanggal_lahir) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('no_ktp') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="no_ktp" id="no_ktp" value="{{ old('no_ktp', $keluarga->no_ktp) }}">
                        ...
                        <div class="form-group {{ $errors->has('no_kk') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="no_kk" id="no_kk" value="{{ old('no_kk', $keluarga->no_kk) }}" required>
                            @if($errors->has('no_kk'))
                        ...
                        <div class="form-group {{ $errors->has('no_bpjskes') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="no_bpjskes" id="no_bpjskes" value="{{ old('no_bpjskes', $keluarga->no_bpjskes) }}">
                        ...
                        <div class="form-group {{ $errors->has('alamat') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="alamat" id="alamat">{{ old('alamat', $keluarga->alamat) }}</textarea>
