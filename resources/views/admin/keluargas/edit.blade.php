...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.keluarga.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.keluargas.update", [$keluarga->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('user') ? 'is-invalid' : '' }}" name="user_id" id="user_id">
                    @foreach($users as $id => $entry)
                        <option value="{{ $id }}" {{ (old('user_id') ? old('user_id') : $keluarga->user->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('user'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama') ? 'is-invalid' : '' }}" type="text" name="nama" id="nama" value="{{ old('nama', $keluarga->nama) }}" required>
                @if($errors->has('nama'))
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('hubungan_keluarga') ? 'is-invalid' : '' }}" name="hubungan_keluarga" id="hubungan_keluarga" required>
                    ...
                    @foreach(App\Models\Keluarga::HUBUNGAN_KELUARGA_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('hubungan_keluarga', $keluarga->hubungan_keluarga) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Keluarga::JENIS_KELAMIN_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('jenis_kelamin') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="jenis_kelamin_{{ $key }}" name="jenis_kelamin" value="{{ $key }}" {{ old('jenis_kelamin', $keluarga->jenis_kelamin) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tempat_lahir') ? 'is-invalid' : '' }}" type="text" name="tempat_lahir" id="tempat_lahir" value="{{ old('tempat_lahir', $keluarga->tempat_lahir) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('tanggal_lahir') ? 'is-invalid' : '' }}" type="text" name="tanggal_lahir" id="tanggal_lahir" value="{{ old('tanggal_lahir', $keluarga->tanggal_lahir) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('agama') ? 'is-invalid' : '' }}" name="agama" id="agama" required>
                    ...
                    @foreach(App\Models\Keluarga::AGAMA_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('agama', $keluarga->agama) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('agama'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_ktp') ? 'is-invalid' : '' }}" type="text" name="no_ktp" id="no_ktp" value="{{ old('no_ktp', $keluarga->no_ktp) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_kk') ? 'is-invalid' : '' }}" type="text" name="no_kk" id="no_kk" value="{{ old('no_kk', $keluarga->no_kk) }}" required>
                @if($errors->has('no_kk'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_bpjskes') ? 'is-invalid' : '' }}" type="text" name="no_bpjskes" id="no_bpjskes" value="{{ old('no_bpjskes', $keluarga->no_bpjskes) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('alamat') ? 'is-invalid' : '' }}" name="alamat" id="alamat">{{ old('alamat', $keluarga->alamat) }}</textarea>
