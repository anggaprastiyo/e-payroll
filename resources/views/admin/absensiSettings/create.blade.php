        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.absensiSetting.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.absensi-settings.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('jam_datang') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control timepicker" type="text" name="jam_datang" id="jam_datang" value="{{ old('jam_datang') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('jam_pulang') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control timepicker" type="text" name="jam_pulang" id="jam_pulang" value="{{ old('jam_pulang') }}" required>
