    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.potongan-gajis.update", [$potonganGaji->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('keterangan') ? 'is-invalid' : '' }}" name="keterangan" id="keterangan">{!! old('keterangan', $potonganGaji->keterangan) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nominal') ? 'is-invalid' : '' }}" type="number" name="nominal" id="nominal" value="{{ old('nominal', $potonganGaji->nominal) }}" step="0.01" required>
