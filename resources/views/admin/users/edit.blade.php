    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.update", [$user->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\User::JENIS_PEGAWAI_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('jenis_pegawai') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="jenis_pegawai_{{ $key }}" name="jenis_pegawai" value="{{ $key }}" {{ old('jenis_pegawai', $user->jenis_pegawai) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\User::JENIS_KELAMIN_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('jenis_kelamin') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="jenis_kelamin_{{ $key }}" name="jenis_kelamin" value="{{ $key }}" {{ old('jenis_kelamin', $user->jenis_kelamin) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_ktp') ? 'is-invalid' : '' }}" type="text" name="no_ktp" id="no_ktp" value="{{ old('no_ktp', $user->no_ktp) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_kk') ? 'is-invalid' : '' }}" type="text" name="no_kk" id="no_kk" value="{{ old('no_kk', $user->no_kk) }}" required>
                @if($errors->has('no_kk'))
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('tmt_masuk') ? 'is-invalid' : '' }}" type="text" name="tmt_masuk" id="tmt_masuk" value="{{ old('tmt_masuk', $user->tmt_masuk) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_bpjstk') ? 'is-invalid' : '' }}" type="text" name="no_bpjstk" id="no_bpjstk" value="{{ old('no_bpjstk', $user->no_bpjstk) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_bpjskes') ? 'is-invalid' : '' }}" type="text" name="no_bpjskes" id="no_bpjskes" value="{{ old('no_bpjskes', $user->no_bpjskes) }}" required>
