                    ...
                    <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('jenis_pegawai') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Models\User::JENIS_PEGAWAI_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="jenis_pegawai_{{ $key }}" name="jenis_pegawai" value="{{ $key }}" {{ old('jenis_pegawai', '1') === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group {{ $errors->has('jenis_kelamin') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\Models\User::JENIS_KELAMIN_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="jenis_kelamin_{{ $key }}" name="jenis_kelamin" value="{{ $key }}" {{ old('jenis_kelamin', '1') === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group {{ $errors->has('no_ktp') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="no_ktp" id="no_ktp" value="{{ old('no_ktp', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('tmt_masuk') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="tmt_masuk" id="tmt_masuk" value="{{ old('tmt_masuk') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('no_bpjstk') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="no_bpjstk" id="no_bpjstk" value="{{ old('no_bpjstk', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('no_bpjskes') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="no_bpjskes" id="no_bpjskes" value="{{ old('no_bpjskes', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('no_rekening') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="no_rekening" id="no_rekening" value="{{ old('no_rekening', '') }}">
